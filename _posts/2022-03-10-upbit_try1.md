...
## 1. javascript용 API문서 확인

제공되는 각 레퍼런스 API를 확인하여 웹 요청시 사용할 Class파일 생성.

##### API 카테고리 체크 및 클래스파일 생성

<img style="border: solid grey 2px;" src="/img/work/upbit_menu.png" width="100%" height="100%"> 	
<br>
제공되는 API 카테고리
<br>
``` javascript
...
<img style="border: solid grey 2px;" src="/img/work/api_chk.png" width="100%" height="100%"> 	
